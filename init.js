...
module.exports = async function () {
  ...
  app.registerContract(1005, 'prodog.buyDog')
  app.registerContract(1006, 'prodog.assignDog')
  app.registerContract(1007, 'prodog.updateDogPair')
  app.registerContract(1008, 'prodog.startPair')
  app.registerContract(1009, 'prodog.endPair')
